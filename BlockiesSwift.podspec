...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BlockiesSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Koray Koska/BlockiesSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Koray Koska' => 'koray@koska.at' }
  s.source           = { :git => 'https://github.com/Koray Koska/BlockiesSwift.git', :tag => s.version.to_s }
